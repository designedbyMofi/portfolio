  ...
  return (
      ...
      <div className={`scrolled-header__content${projectDetail ? ' is-project' : ''}`}>
        ...
        <div className="scrolled-header__identity">
          ...
          <a className="scrolled-header__crumb" href="/" onClick={(event) => { event.preventDefault(); onNavigate('shots'); }}>Mofifoluwa</a><span className="scrolled-header__muted">/</span>
          {projectDetail ? <a className="scrolled-header__crumb" href="/projects" onClick={(event) => { event.preventDefault(); onBack(); }}>Projects</a> : active === 'projects' ? <a className="scrolled-header__crumb scrolled-header__active" href="/projects" onClick={(event) => event.preventDefault()}>Projects</a> : active === 'resume' ? <a className="scrolled-header__crumb scrolled-header__active" href="/resume" onClick={(event) => event.preventDefault()}>Résumé</a> : <span className="scrolled-header__muted">Shots</span>}
