...
const experiences: Experience[] = [
  {
    company: 'Cyvi', location: 'Sweden', period: 'Nov 2023 - Sep 2025', role: 'Product Designer',
  ...
  {
    company: 'Vurt', location: 'Nigeria', period: 'Nov 2021 - Present', role: 'Head of Design',
  ...
  {
    company: 'PressOne Africa', location: 'Nigeria', period: 'Jan 2026 - Mar 2026', role: 'UX Designer',
  ...
  {
    company: 'Dysol', location: 'Dubai', period: 'Jan 2025 - Apr 2026', role: 'Product Designer',
  ...
  { company: 'Netact Services Inc.', location: 'Canada', period: 'July 2022 - Aug 2023', role: 'Creative Designer' },
];
        ...
        <div className={`preview__media preview__media--${project.kind}`}>
          ...
          {project.motion === 'carousel' && (
            <div className="preview__carousel-controls" aria-label="Carousel controls">
              <button className="preview__carousel-button" onClick={() => changeSlide(-1)} aria-label="Previous slide"><span className="carousel-arrow carousel-arrow--prev" aria-hidden="true" /></button>
              ...
              <button className="preview__carousel-button" onClick={() => changeSlide(1)} aria-label="Next slide"><span className="carousel-arrow carousel-arrow--next" aria-hidden="true" /></button>
            </div>
          )}
        </div>
          ...
          {experiences.map((experience) => (
            <article className="experience-card" key={`${experience.company}-${experience.period}`} tabIndex={0}>
              <div className="experience-card__heading">
                <div><strong>{experience.company}</strong><span>, {experience.location}</span></div>
