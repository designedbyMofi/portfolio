...
const projects: Project[] = [
  ...
  { image: '/assets/project-04.png', alt: 'Internal company communication platform', hoverDescription: 'Internal team communication', kind: 'mobile', motion: 'video', video: '/assets/communication-preview.mov' },
  {
    ...
    carouselImages: [
      ...
      '/assets/thrift-onboarding-04.jpg',
      '/assets/thrift-onboarding-05.jpg',
      '/assets/thrift-onboarding-06.jpg',
      '/assets/thrift-onboarding-07.jpg',
      '/assets/thrift-onboarding-08.jpg',
      '/assets/thrift-onboarding-09.jpg',
      '/assets/thrift-onboarding-10.jpg',
    ],
  },
  {
    ...
    motion: 'carousel',
    carouselImages: [
      '/assets/thrift-feed-01.jpg',
      '/assets/thrift-feed-02.jpg',
      '/assets/thrift-feed-03.jpg',
      '/assets/thrift-feed-04.jpg',
      '/assets/thrift-feed-05.jpg',
      '/assets/thrift-feed-06.jpg',
      '/assets/thrift-feed-07.jpg',
      '/assets/thrift-feed-08.jpg',
      '/assets/thrift-feed-09.jpg',
    ],
  },
  {
    ...
    carouselImages: [
      ...
      '/assets/thrift-inbox-05.jpg',
      '/assets/thrift-inbox-06.jpg',
      '/assets/thrift-inbox-07.jpg',
  ...
  { image: '/assets/project-07.png', alt: 'Messaging mobile screen', hoverDescription: 'Real-time team messaging', kind: 'mobile', motion: 'video' },
  { image: '/assets/project-03.png', alt: 'Find the one you trust mobile flow', hoverDescription: 'Finding a trusted exchanger', kind: 'mobile', motion: 'video' },
...
function ProjectPreview({ project, origin, nativeTransition, closing, onClose, onExitComplete }: { project: Project; origin: PreviewOrigin | null; nativeTransition: boolean; closing: boolean; onClose: () => void; onExitComplete: () => void }) {
  ...
  return (
    <div className={`preview${nativeTransition ? ' is-photos-transition' : ''}${closing ? ' is-closing' : ''}${project.motion === 'carousel' ? ' is-carousel-preview' : ''}`} role="dialog" aria-modal="true" aria-label={project.alt} onClick={onClose}>
      ...
      <p className="preview__description">{displayedProject.hoverDescription ?? displayedProject.alt}</p>
    </div>
  );
}
