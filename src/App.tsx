  ...
  return (
    <article className="case-study" aria-labelledby="vurt-title">
      ...
      <section className="case-study__intro case-study__section" id="vurt-intro">
        ...
        <div className="case-study__intro-copy"><span className="case-study__section-number">01: Intro</span><h2>Currency gets its value from people, not just banks.</h2><p>Vurt began as QPay, a mobile-first exchange app for people moving money across currencies. The first version proved the need, but it made a high-stakes transaction feel harder than it needed to be.</p><p>The redesign turned that early product into a P2P marketplace: customers could compare offers and choose who to trade with, while Vurt handled the coordination and risk underneath.</p></div>
      </section>

      <section className="case-study__simple-section" id="vurt-metrics"><div><span className="case-study__section-number">02: Metrics</span><h2>The clearest signal came from onboarding.</h2></div><div><p>Onboarding completion rose from 26% to 67.6% after the redesign—a 160% increase.</p><p>That was the clearest evidence that reducing the first-use burden was doing its job. The Beta’s early traction gave us a second signal: people were willing to return when the exchange felt useful and dependable.</p></div></section>
      <section className="case-study__simple-section" id="vurt-role"><div><span className="case-study__section-number">03: My role</span><h2>I owned the product direction from strategy to handoff.</h2></div><div><p>As Head of Design and Product, I led the product strategy, UX, UI, and design system across the customer and exchanger experiences.</p><p>The team was one product manager, three developers, and three designers. I handled the core product direction and worked closely with stakeholders throughout. The other designers extended the system across mobile viewports and features such as KYC, bank-account listing, and exchanger ads.</p></div></section>
